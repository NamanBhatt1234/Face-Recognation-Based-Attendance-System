...
class student_window:
    ...
    def fetch_database(self):
        ...
        if len(table_data)!=0:
            ...
            print(*self.student_table.get_children())
        ...
        if self.var_dep.get()=='' or self.var_name.get()=='' or self.var_id=='':
            ...
            try:
                ...
                if update>0:
                    ...
                    #The MySQLCursor class instantiates objects that can execute operations such as SQL statements. Cursor objects interact with the MySQL server using a MySQLConnection object.
                    database_access=con.cursor()
                    #print( "update students set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,PhotoSample=%s where student_id=%s",(
                    #                            self.var_dep.get(),
                     #                           self.var_course.get(),
                      #                          self.var_year.get(),
                       #                         self.var_semester.get(),
                             ...
                             #                   self.var_email.get(),
                              #                  self.var_phone.get(),
                               #                 self.var_radiobtn1.get(),
                                #                self.var_id.get()
                                 #              ))
                    print("update students set Dep='"+self.var_dep.get()+"',course='"+self.var_course.get()+"',Year='"+self.var_year.get()+"',Semester='"+self.var_semester.get()+"',Name='"+self.var_name.get()+"',Division='"+self.var_div.get()+"',Roll='"+self.var_roll.get()+"',Gender='"+self.var_gender.get()+"',Dob='"+self.var_dob.get()+"',Email='"+self.var_email.get()+"',Phone='"+self.var_phone.get()+"',PhotoSample='"+self.var_radiobtn1.get()+"' where student_id='"+self.var_id.get()+"'")
                    database_access.execute("update students set Dep='"+self.var_dep.get()+"',course='"+self.var_course.get()+"',Year='"+self.var_year.get()+"',Semester='"+self.var_semester.get()+"',Name='"+self.var_name.get()+"',Division='"+self.var_div.get()+"',Roll='"+self.var_roll.get()+"',Gender='"+self.var_gender.get()+"',Dob='"+self.var_dob.get()+"',Email='"+self.var_email.get()+"',Phone='"+self.var_phone.get()+"',PhotoSample='"+self.var_radiobtn1.get()+"' where student_id='"+self.var_id.get()+"'")
                    database_access.execute("commit")    
        ...
        if self.var_id.get()=="":
            ...
            try:
                ...
                if delete>0:
                    ...
                    #The MySQLCursor class instantiates objects that can execute operations such as SQL statements. Cursor objects interact with the MySQL server using a MySQLConnection object.
                    database_access=con.cursor()
                    database_access.execute("delete from students where student_id="+self.var_id.get())
    ...
    def generate_imgDataset(self):
        if self.var_dep.get()=='Select ' or self.var_name.get()=='' or self.var_id=='':
            ...
            try:
                ...
                con=mysql.connector.connect(host="localhost",user="root",password="1234",database="student_data",autocommit=True)
                #The MySQLCursor class instantiates objects that can execute operations such as SQL statements. Cursor objects interact with the MySQL server using a MySQLConnection object.
                database_access=con.cursor()
                database_access.execute("select *from students")
